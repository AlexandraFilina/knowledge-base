  ...
  return (
    <div className="flex flex-col h-full max-w-sm rounded-2xl border border-stone-200 bg-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition duration-200">
      {image ? (
        ...
        <div className="h-44 bg-stone-100 rounded-t-2xl flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex flex-col flex-1 px-5 py-4">
        ...
        <p className="text-sm text-stone-600 line-clamp-2 min-h-[3rem]">
          {description}
        </p>
